    ...
    <div className="font-sans max-w-4xl max-md:max-w-xl mx-auto p-4">
      <div className="flex items-center justify-between">
        ...
        <h2 className="flex items-center gap-2">
          Total Items: {cart ? cart.numOfCartItems : 0}
          <FaRegTrashAlt
                ...
                >
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="mt-auto flex items-center gap-3">
                        ...
                        <button
                          ...
                          type="button"
                          className="flex items-center justify-center w-5 h-5 bg-gray-800 outline-none rounded-full text-white"
                        >
                          <IoMdAdd />
                        </button>
                      </div>
                  ...
                  <div className="ml-auto flex flex-col">
                    <div className="flex items-start gap-4 justify-end">
                      <FaRegHeart className="text-gray-400 hover:text-pink-600 text-lg cursor-pointer" />
                      <FaRegTrashAlt
                        className="text-gray-400 hover:text-red-600 text-lg cursor-pointer"
